...
۱۸.
این sema_up متناظر sema_down در قسمت process_wait است، در آن بخش پس از اجرای process_execute منتظر مانده تا مقدار temporory توسط یک sema_up دیگر که در بخش انتهایی تابع process_execute هست یکی زیاد شده تا مقدار آن مثبت شود و بتواند به اجرای برنامه خود در آن قسمت بپردازد.

	process.c:36 -> sema_init (&temporary, 0);
	process.c:121 -> sema_up (&temporary);
